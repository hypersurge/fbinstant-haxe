 ...
 * @enum {string}
 */
@:native("FBInstant.ErrorCodeType")
@:enum extern abstract ErrorCodeType( String )
{
	/**
	 * Ads are being loaded too frequently.
	 */
	var ADS_FREQUENT_LOAD = "ADS_FREQUENT_LOAD";
	/**
	 ...
	 * @deprecated
	 */
	var CLIENT_REQUIRES_UPDATE = "CLIENT_REQUIRES_UPDATE";
	/**
	 ...
	 */
	var CLIENT_UNSUPPORTED_OPERATION = "CLIENT_UNSUPPORTED_OPERATION";
	/**
	 ...
	 */
	var LEADERBOARD_NOT_FOUND = "LEADERBOARD_NOT_FOUND ";
	/**
	 ...
	 */
	var LEADERBOARD_WRONG_CONTEXT = "LEADERBOARD_WRONG_CONTEXT";
	/**
	 ...
	 */
	var NETWORK_FAILURE = "NETWORK_FAILURE";
	/**
